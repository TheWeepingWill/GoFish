...
describe '#CardDeck' do 
    it 'initializes a standard deck' do 
        ...
        expect(deck.cards.first).to eq '2 of Hearts' 
        expect(deck.cards.last).to eq 'Ace of Diamonds' 
    end
    ...
    it 'initializes with given cards' do 
        ...
        expect(deck.cards.first).to eq 'Ace of Spades' 
        expect(deck.cards.last).to eq '4 of Clubs' 
    end
